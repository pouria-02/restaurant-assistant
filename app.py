...
menu = {
    ...
    "برگر چیز": "گوشت گوساله، نان برگر، پنیر چدار، بیکن، کاهو، گوجه، سس مخصوص",
    ...
    "تیرامیسو": "کیک اسپنج، ماسکارپونه، قهوه، پودر کاکائو",
    "نوشابه": "آب گازدار، شکر، طعم‌دهنده",
    "آب معدنی": "آب معدنی طبیعی"
}
