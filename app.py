...
/* 🟢 استایل دهی جدید برای باکس ورودی دستیار (st.text_input) 🟢 */

/* استایل کانتینر اصلی ورودی (شامل پس‌زمینه و بوردر) */
.stTextInput > div > div {
    /* 1. پس‌زمینه هم‌رنگ پس‌زمینه کلی اپلیکیشن */
    background-color: #FFF4D6; /* رنگ کرمی */
    /* 2. بوردر سبز همرنگ قیمت‌ها */
    border: 2px solid #2ECC71 !important; 
    border-radius: 0.5rem; /* گرد کردن لبه‌ها برای زیبایی */
    box-shadow: none !important;
}

/* 3. رنگ خاکستری برای لیبل (سوال خود را بنویسید...) */
.stTextInput > label {
    color: #555555 !important; /* خاکستری تیره برای خوانایی بهتر */
    font-weight: normal !important;
}

/* 4. رنگ متن ورودی (متنی که تایپ می‌شود) */
.stTextInput > div > div > input {
    color: #000000 !important; /* متن ورودی مشکی برای وضوح */
    background-color: #FFF4D6 !important; /* اطمینان از هم‌رنگی پس‌زمینه داخلی */
}
