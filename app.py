...
def restaurant_assistant(question):
    ...
    menu_for_prompt = {
     ...
     system_prompt = (
        ...
        "اگر کاربری نیاز به درد و دل داشت میتونی باهاش درد و دل کنی و آرومش کنی. در این حالت لازم نیست لحن خیلی شادی داشته باشی و با مهمان همراهی کن. میتونی آهنگ های آرامش بخش معروف هم در صورت نیاز پیشنهاد بدی."
        ...
        f"منو:\n{menu_without_images(MENU_FOR_PROMPT)}"
    )
